...
public class CameraController : MonoBehaviour
{
     ...
     private string[] tags = {"Camera_Corridoi","Camera_Ingresso", "Camera_Cucina", "Camera_Altarino", "Camera_Bedroom1", "Camera_Bedroom2"};
